...
class Register(customtkinter.CTk):
    def __init__(self, root1):
        ...
        self.root.screen_width = root1.winfo_screenwidth()
        self.root.screen_height = root1.winfo_screenheight()
        self.root.state('zoomed')
        self.root.minsize(self.root.screen_width, self.root.screen_height)
        self.root.iconbitmap("C:\\Users\\KIIT\\OneDrive\\Documents\\cme "
        ...
        North_Frame = customtkinter.CTkFrame(master=root1, height=100, corner_radius=0)
        ...
        back_image = Image.open('C:\\Users\\KIIT\\OneDrive\\Documents\\cme '
                                'project\\Cab-Booking-System\\Images\\back.png')
        ...
        Right_frame = customtkinter.CTkFrame(master=root1)
        ...
        Cover_Image = Image.open(
            'C:\\Users\\KIIT\\OneDrive\\Documents\\cme project\\Cab-Booking-System\\Images\\Taxi.png')
        ...
        name_lbl = Label(root1, text="Name: ", bg="#212325", fg="white", font=font)
        name_lbl.place(x=630, y=250)

        name_txt = customtkinter.CTkEntry(master=root1, fg_color='white', text_color='black', font=font1,
                                          width=250)
        name_txt.configure(textvariable=self.name_txt)
        name_txt.place(x=650, y=200)

        dob_lbl = Label(root1, text="DOB: ", bg="#212325", fg="white", font=font)
        ...
        style.configure('my.DateEntry',
                        ...
                        foreground='black',
                        arrowcolor='red')
        dob_txt = DateEntry(root1, font=font1, selectmode='day', style='my.DateEntry', background="green",
                            bordercolor="red",
                            selectbackground="green", width=17, date_pattern='yyyy-mm-dd')

        dob_txt.place(x=820, y=320)

        gender_lbl = Label(root1, text="Gender: ", bg="#212325", fg="white", font=font)
        gender_lbl.place(x=1350, y=250)

        gender_txt = customtkinter.CTkOptionMenu(master=root1, fg_color='white', variable=self.gender_txt,
                                                 text_color='black',
                                                 values=['Male', 'Female', 'Others'], font=font1, width=250)
        gender_txt.set('Male')
        gender_txt.place(x=1240, y=200)

        mobile_lbl = Label(root1, text="Mobile: ", bg="#212325", fg="white", font=font)
        mobile_lbl.place(x=1350, y=320)

        mobile_txt = customtkinter.CTkEntry(master=root1, fg_color='white', text_color='black', font=font1,
                                            width=250)
        mobile_txt.configure(textvariable=self.mobile_txt)
        mobile_txt.place(x=1240, y=250)

        address_lbl = Label(root1, text="Address: ", bg="#212325", fg="white", font=font)
        address_lbl.place(x=630, y=395)

        address_txt = customtkinter.CTkEntry(master=root1, fg_color='white', text_color='black',
                                             font=font1, width=250)
        address_txt.configure(textvariable=self.address_txt)
        address_txt.place(x=650, y=310)

        email_lbl = Label(root1, text="Email: ", bg="#212325", fg="white", font=font)
        email_lbl.place(x=1350, y=390)

        email_txt = customtkinter.CTkEntry(master=root1, fg_color='white', text_color='black', font=font1,
                                           width=250)
        email_txt.configure(textvariable=self.email_txt)
        email_txt.place(x=1240, y=305)

        password_lbl = Label(root1, text="Password: ", bg="#212325", fg="white", font=font)
        password_lbl.place(x=630, y=465)

        password_txt = customtkinter.CTkEntry(master=root1, fg_color='white', text_color='black',
                                              font=font1, width=250)
        password_txt.configure(textvariable=self.password_txt)
        password_txt.place(x=650, y=365)

        credit_lbl = Label(root1, text="Credit No: ", bg="#212325", fg="white", font=font)
        credit_lbl.place(x=1350, y=460)

        credit_txt = customtkinter.CTkEntry(master=root1, fg_color='white', text_color='black', font=font1,
                                            width=250)
        ...
        def save_customer_info():
            ...
            if (name_txt.get() == '') or (dob_txt.get() == '') or (gender_txt.get() == '') or (mobile_txt.get() == '') \
                    ...
                    credit_txt.get() == 0):
                warning = messagebox.showwarning("Cab Booking System", "Please enter all the field!")
                ...
                if result == True:
                    promt = messagebox.showinfo('Cab Booking System', "Customer is registered successfully")
                else:
                    promt1 = messagebox.showerror("Error!", "Registration of customer info is unsuccessful!")

        register_btn_image = customtkinter.CTkImage(light_image=Image.open(
            "C:\\Users\\KIIT\\OneDrive\\Documents\\cme project\\Cab-Booking-System\\Images\\edit.png"))

        register_btn = customtkinter.CTkButton(master=root1, command=save_customer_info, text="Register",
        ...
        def clear():
            ...
            if (name_txt.get() == '') or (mobile_txt.get() == '') or (credit_txt.get() == '') or \
                    ...
                    (email_txt.get() == ''):
                msg1 = messagebox.showinfo("Cab Booking System", "All fields are cleared!")

            else:
                msg2 = messagebox.showerror("Error!", "Error ocurred!")

        # Clear btn image and button
        clear_btn_image = customtkinter.CTkImage(light_image=Image.open(
            "C:\\Users\\KIIT\\OneDrive\\Documents\\cme project\\Cab-Booking-System\\Images\\cleaning.png"))
        clear_btn = customtkinter.CTkButton(master=root1, command=clear, text="Clear", image=clear_btn_image,
                                            hover_color='black', font=('Tahoma', 20, 'bold'))
        clear_btn.place(x=1080, y=500)

        # Back button and label widget
        back_lbl = customtkinter.CTkLabel(master=root1, text="Already have an account",
                                          font=('', 14, 'normal'),
                                          text_color='white')
        back_lbl.place(x=920, y=550)

        back_btn = customtkinter.CTkButton(master=root1, text="SIGN IN", width=100, font=('Tahoma', 14, 'bold'),
