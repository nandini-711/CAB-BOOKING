...
class Login(customtkinter.CTk):
    def __init__(self, root):
        ...
        self.root.iconbitmap("C:\\Users\\KIIT\\OneDrive\\Documents\\cme project\\Taxi-Booking-System-master\\Images\\logo.png")
        ...
        image=ImageTk.PhotoImage(Image.open("C:\\Users\\KIIT\\OneDrive\\Documents\\cme "
                                            "project\\Taxi-Booking-System-master\\Images\\Tablet login-rafiki.png"))
        ...
        # Image
        sign_in_image = Image.open('C:\\Users\\KIIT\\OneDrive\\Documents\\cme '
                                   'project\\Taxi-Booking-System-master\\Images\\hyy.png')
        ...
        psswrd_text1 = customtkinter.CTkEntry(master=parent_tab.tab('Sign In'), show="*", corner_radius=10, font=font1, width=200)
        psswrd_text1.place(x=330, y=250)

        # password checkbox widget
        ...
        def login_customer():
            login720=Customer_Libs(email=email_txt1.get(), password=psswrd_text1.get())
            user=login(login720)
            driverresult=driverlogin(login720)
            adminresult=adminLogin(login720)

            if email_txt1.get()=="" or psswrd_text1.get()=='':
                ...
                if user != None:
                    ...
                    self.root.destroy()
                    root = customtkinter.CTk()
                    obj2 = admin_dashboard.AdminDashboard(root)
                    root.mainloop()
        ...
        # Login Button
        add_login_image = customtkinter.CTkImage(light_image=Image.open("C:\\Users\\KIIT\\OneDrive\\Documents\\cme "
                                                                        "project\\Taxi-Booking-System-master\\Images"
                                                                        "\\login.png").resize((50, 50)))
        ...
        # Password Entry
        psswrd_text = customtkinter.CTkEntry(master=parent_tab.tab('Sign Up'), font=font1, width=200)
        psswrd_text.configure(textvariable=self.psswrd_text)
        psswrd_text.place(x=110, y=300)
        ...
        def save_customer_info():
            ...
            passwordResult=passwordvalidation(psswrd_text.get())
        ...
        # Registration button
        register_btn_image = customtkinter.CTkImage(light_image=Image.open("C:\\Users\\KIIT\\OneDrive\\Documents\\cme project\\Taxi-Booking-System-master\\Images\\edit.png"))
        ...
        def clear():
            ...
            self.psswrd_text.set('')
            self.email_txt.set('')

            if (name_txt.get() == '') or (mobile_txt.get() == '') or (credit_txt.get()=='') or \
               (address_txt.get() == '') or (psswrd_text.get() == '') or \
               (email_txt.get() == ''):
        ...
        # Clear Button
        clear_btn_image = customtkinter.CTkImage(light_image=Image.open("C:\\Users\\KIIT\\OneDrive\\Documents\\cme project\\Taxi-Booking-System-master\\Images\\cleaning.png"))
