...
class Customer_Dashboard(customtkinter.CTk):
    ...
    def __init__(self, root):
        ...
        self.root.title("Customer Dashboard | Cab-Booking-System")
        self.root.state('zoomed')
        self.root.bind('<Escape>', lambda e: root.destroy())
        self.root.iconbitmap("C:\\Users\KIIT\OneDrive\Documents\cme project\Cab-Booking-System\Images\logo.ico")
        ...
        title_lbl = customtkinter.CTkLabel(master=Top_Frame, text="Cab-Booking-System", font=titlefont)
        ...
        Cover_Image = Image.open('C:\\Users\KIIT\OneDrive\Documents\cme '
        ...
        assigndriver_btn_image = customtkinter.CTkImage(light_image=Image.open('C:\\Users\KIIT\OneDrive\Documents\cme project\Cab-Booking-System\Images\edit-alt-regular-24.png'))
        ...
        profile_img = customtkinter.CTkImage(light_image=Image.open('C:\\Users\KIIT\OneDrive\Documents\cme project\Cab-Booking-System\Images\\user-account-solid-24.png'))
        ...
        managecustomers_btn_image = customtkinter.CTkImage(light_image=Image.open('C:\\Users\\KIIT\\OneDrive\\Documents\\cme project\\Cab-Booking-System\\Images\\user-regular-24.png'))
        ...
        managedrivers_btn_image = customtkinter.CTkImage(light_image=Image.open('C:\\Users\KIIT\OneDrive\Documents\cme project\Cab-Booking-System\Images\car-regular-24.png'))
        ...
        billing_btn_image = customtkinter.CTkImage(light_image=Image.open('C:\\Users\KIIT\OneDrive\Documents\cme '
                                                                          'project\Cab-Booking-System\Images\id-card'
                                                                          '-regular-24.png'))
        ...
        def change_password_gui():
            ...
            password.title("Cab-Booking-System | Change Customer Password")
            ...
            img = ImageTk.PhotoImage(Image.open("C:\\Users\KIIT\OneDrive\Documents\cme project\Cab-Booking-System\Images\\Images\\user-solid-72.png"))
            ...
            def change_password():
                ...
                if password1 == newpassword:
                    ...
                    if result == True:
                        messagebox.showinfo("Cab-Booking-System", "The password is changed successfully!")
                        self.root.destroy()
                        root=customtkinter.CTk()
                        login.Login(root)
                        root.mainloop()
                    else:
                        messagebox.showerror("Cab-Booking-System", "Error occurred!")

                else:
                    messagebox.showerror("Cab-Booking-System", "The password does not match. Please try again!")
        ...
        viewcustomer_btn_image = customtkinter.CTkImage(light_image=Image.open('C:\\Users\KIIT\OneDrive\Documents\cme project\Cab-Booking-System\Images\\key-solid-24.png'))
        ...
        def delete_account():
            ...
            if dialogResult=='YES':
                ...
                if deleteResult and deleteActivityResult == True:
                    messagebox.showinfo("Cab-Booking-System", "The account is deleted successfully")
                    self.root.destroy()
                    root=customtkinter.CTk()
                    login.Login(root)
                    root.mainloop()
            else:
                messagebox.showinfo("Cab-Booking-System", "The account delete is cancelled")

        # Delete Account Button
        delete_btn_image = customtkinter.CTkImage(light_image=Image.open('C:\\Users\KIIT\OneDrive\Documents\cme project\Cab-Booking-System\Images\\user-x-regular-24.png'))
        ...
        # Logout Button
        logout_btn_image = customtkinter.CTkImage(light_image=Image.open('C:\\Users\KIIT\OneDrive\Documents\cme project\Cab-Booking-System\Images\log-out-circle-regular-24.png'))
        ...
        time_img=customtkinter.CTkImage(light_image=Image.open("C:\\Users\KIIT\OneDrive\Documents\cme project\Cab-Booking-System\Images\\time-five-regular-24.png"))
        ...
        def request_booking():
            ...
            pickuptime=pick_up_time_lbl.get()
            ...
            if pickup_address_txt.get()=='' or pick_up_time_lbl.get()=='' or dropoff_txt1.get()=='' or date_lbl_txt.get()=='':
                messagebox.showwarning("Cab-Booking-System","Please enter all the field")

            elif checkResult!=None:
                messagebox.showwarning("Cab-Booking-System","You have already requested on this date")



            else:
                booking = BookingLibs(bookingid='', pickupaddress=pickup, date=date720, time=pickuptime,
                                      dropoffaddress=dropoff, bookingstatus='Pending', cid=cid11)
                insertResult = insert_booking(booking)
                messagebox.showinfo("Cab-Booking-System", "The booking is requested successfully!")
        ...
        time_img = customtkinter.CTkImage(light_image=Image.open("C:\\Users\KIIT\OneDrive\Documents\cme project\Cab-Booking-System\Images\Images\\time-five-regular-24.png"))
        ...
        def update_customer_booking():
            ...
            if updatebookingid.get()=='' or pickupaddresstxt.get()=='' or updatedatetxt.get()=='' or updatepickuptxt.get()=='' or updatedropofftxt.get()=='':
                messagebox.showwarning("Cab-Booking-System","Please fill all the fields")

            elif validateresult!=None:
                date3=updatedatetxt.get()
                if date3<today720:
                    messagebox.showwarning("Cab-Booking-System","You have outdated date. Please select new pickup date!")
                    ...
                    if updatebookingResult == True:
                        ...
                        messagebox.showinfo("Cab-Booking-System", "The booking request is updated successfully")
                        updatebookingtable.delete(*updatebookingtable.get_children())
                        bookingtable()
        ...
        def cancel_booking():
            ...
            if Deleteresult==True:
                messagebox.showinfo("Cab-Booking-System","The booking is cancel successfully!")
                updatebookingtable.delete(*updatebookingtable.get_children())
                bookingtable()
        ...
        sql_engine = create_engine('mysql+pymysql://root:@3306/cab_booking_system')
