    ...
    def __init__(self, main):
        ...
        def searchCustomer():
            ...
            if customerResult==None:
                messagebox.showwarning("Cab-Booking-System", "The Customer ID {} is not found".format(customerid))
        ...
        def delete():
            ...
            if deleteResult==True:
                messagebox.showinfo("Cab-Booking-System","The customer ID {} is deleted successfully".format(customerid))
