...
class UpdateCustomerProfile():
    def __init__(self, updateprofile):
        ...
        self.updateprofile.iconbitmap("C:\\Users\KIIT\OneDrive\Documents\cme project\Taxi-Booking-System-master\Images\logo.ico")
        width = 750
        height = 440
        ...
        def updatecustomer():
            ...
            if updateResult==True:
                messagebox.showinfo("Cab-Booking-System","The {} details is updated successfully!".format(Global.currentUser[1]))
                self.updateprofile.destroy()

            else:
                messagebox.showerror("Cab-Booking-System","Error")

        update_btn_image = customtkinter.CTkImage(light_image=Image.open('C:\\Users\KIIT\OneDrive\Documents\cme project\Taxi-Booking-System-master\Images\edit-alt-regular-24.png'))
        ...
        # Image Label
        user_image = ImageTk.PhotoImage(Image.open("C:\\Users\KIIT\OneDrive\Documents\cme project\Taxi-Booking-System-master\Images\\user-solid-120.png"))
