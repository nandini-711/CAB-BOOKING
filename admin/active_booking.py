...
class ActiveBooking():
    def __init__(self, main):
        ...
        titlelbl = customtkinter.CTkLabel(topFrame, text='CUSTOMER ACTIVE BOOKING', font=font1)
        titlelbl.place(relx=0.5, rely=0.5, anchor=CENTER)
        ...
        treeView['columns'] = (
            'bookingid', 'customername', 'pickupaddress', 'dropoffaddress', 'date', 'time', 'drivername',
            'bookingstatus')
