...
from dbms.booking_backend import total_booking, select_all, update_booking, total_revenue, validateadminbooking, update_booking11
...
class AdminDashboard(customtkinter.CTk):
    def __init__(self, main):
        ...
        def assign_driver():
            ...
            root.iconbitmap("C://Users//KIIT//OneDrive//Documents//cme "
                            "project//Cab-Booking-System//Images//logo.ico")
            root.resizable(0,0)
            ...
            pickup_addr_lbl = customtkinter.CTkLabel(assignbookingFrame, text="Pick up: ",font=font720)
            pickup_addr_lbl.place(x=30, y=100)
            ...
            time_img = customtkinter.CTkImage(light_image=Image.open("C://Users//KIIT//OneDrive//Documents//cme "
                                                                     "project//Cab-Booking-System//Images//time"
                                                                     "-five-regular-24.png"))
        ...
        assigndriver_btn_image = customtkinter.CTkImage(light_image=Image.open('C://Users//KIIT//OneDrive//Documents'
                                                                               '//cme '
                                                                               'project//Cab-Booking-System'
                                                                               '//Images//edit-alt-regular-24.png'))
        ...
        payment_btn_image = customtkinter.CTkImage(light_image=Image.open('C://Users//KIIT//OneDrive//Documents/cme '
                                                                          'project//Cab-Booking-System//Images'
                                                                          '//paypal-logo-24.png'))
        ...
        managecustomers_btn_image = customtkinter.CTkImage(light_image=Image.open('C://Users//KIIT//OneDrive'
                                                                                  '/Documents//cme '
                                                                                  'project//Cab-Booking-System'
                                                                                  '//Images//user-regular-24.png'))
        ...
        manageemployees_btn_image = customtkinter.CTkImage(light_image=Image.open('C://Users//KIIT//OneDrive//Documents//cme project//Cab-Booking-System//Images//id-card-regular-24.png'))
        ...
        viewcustomer_btn_image = customtkinter.CTkImage(light_image=Image.open('C://Users//KIIT//OneDrive//Documents//cme '
                                                                               'project//Cab-Booking-System'
                                                                               '//Images//book-content-regular-24.png'))
        ...
        viewdriver_btn_image = customtkinter.CTkImage(light_image=Image.open('C://Users/KIIT/OneDrive/Documents/cme '
                                                                             'project/Cab-Booking-System/Images'
                                                                             '//money-withdraw-regular-24.png'))
        ...
        logout_btn_image = customtkinter.CTkImage(light_image=Image.open('C://Users/KIIT/OneDrive/Documents/cme '
                                                                         'project/Cab-Booking-System/Images'
                                                                         '//log-out-circle-regular-24.png'))
        ...
        tmpResult = result[0]
        frame1_label2 = customtkinter.CTkLabel(master=frame1, text="Total /nCustomers /n/n{}".format(tmpResult[0]), font=labelfont)
        ...
        frame2_label2 = customtkinter.CTkLabel(master=frame2, text="Total /nBookings /n/n{}".format(bookingresult2[0]),font=labelfont)
        ...
        frame3_label2 = customtkinter.CTkLabel(master=frame3, text="Total /nDrivers /n/n{}".format(driveresult2[0]),font=labelfont)
        ...
        frame4_label2 = customtkinter.CTkLabel(master=frame4, text="Total /nRevenues /n/n{}".format(totalResult2[0]),
                                               font=labelfont)
        ...
        frame1_label1 = customtkinter.CTkButton(master=tab2frame1,text="Search /nCustomer",command=search_customers11,font=labelfont,fg_color='#2b2b2b',)
        ...
        def search_employees11():
            ...
            root.mainloop()
        frame3_label3 = customtkinter.CTkButton(master=tab2frame3, text="Search /nEmployees",command=search_employees11, font=labelfont,fg_color='#2b2b2b', )
        ...
        def driver_report720():
            ...
            root.mainloop()
        tab3_label2 = customtkinter.CTkButton(master=tab3frame2, text="Driver /nReports",command=driver_report720, font=labelfont,fg_color='#2b2b2b', )
        ...
        def booking_report720():
            ...
            root.mainloop()
        tab3_label3 = customtkinter.CTkButton(master=tab3frame3, text="Booking /nReports",command=booking_report720, font=labelfont,fg_color='#2b2b2b', )
        ...
        def billing_report720():
            ...
            root.mainloop()
        tab4_label4 = customtkinter.CTkButton(master=tab4frame4,command=billing_report720, text="Billing /nReports", font=labelfont,
                                              fg_color='#2b2b2b', )
