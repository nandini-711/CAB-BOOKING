    ...
    def __init__(self, main):
        ...
        def searchEmployees():
            ...
            if employeesResult==None:
                messagebox.showwarning("Cab Booking System", "The Employees ID {} is not found".format(employeesid))
        ...
        search_image = customtkinter.CTkImage(light_image=Image.open("C:\\Users\KIIT\OneDrive\Documents\cme project\Cab-Booking-System\Images\\search-alt-2-regular-24.png"))
        ...
        def save_employees_info():
            ...
            if (nametxt.get() == '') or (dobtxt.get() == '') or (gendertxt.get() == '') or (mobiletxt.get() == '') \
                ...
                if result == True:
                    promt = messagebox.showinfo('Cab Booking System', "Employees detail is registered successfully")
                else:
                    promt1 = messagebox.showerror("Error!", "Registration of employees info is unsuccessful!")



        save_image = customtkinter.CTkImage(light_image=Image.open("C:\\Users\KIIT\OneDrive\Documents\cme project\Cab-Booking-System\Images\check-square-regular-24.png"))
        ...
        def update():
            ...
            if updateResult==True:
                messagebox.showinfo("Cab Booking System","The record is updated")

            else:
                messagebox.showwarning("Cab Booking System","The record is not updated")



        update_image = customtkinter.CTkImage(light_image=Image.open("C:\\Users\KIIT\OneDrive\Documents\cme project\Cab-Booking-System\Images\edit-alt-regular-24.png"))
        ...
        def delete():
            ...
            if deleteResult==True:
                messagebox.showinfo("Cab Booking System","The employees ID {} is deleted successfully".format(employeesid))
        ...
        delete_image = customtkinter.CTkImage(light_image=Image.open(
            "C:\\Users\KIIT\OneDrive\Documents\cme project\Cab-Booking-System\Images\\user-x-regular-24.png"))
        ...
        clear_image = customtkinter.CTkImage(light_image=Image.open("C:\\Users\KIIT\OneDrive\Documents\cme project\Cab-Booking-System\Images\\user-x-regular-24.png"))
