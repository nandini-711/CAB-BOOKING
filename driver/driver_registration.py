...
class DriverRegistration():
    ...
    def __init__(self, driver1):
        ...
        def searchdriver():
            ...
            if idtxt.get()=='':
                messagebox.showerror("Cab Booking System", "The user not found")
        ...
        search_image = customtkinter.CTkImage(light_image=Image.open("C:\\Users\\KIIT\\OneDrive\\Documents\\cme "
                                                                     "project\\Cab-Booking-System-master\\Images"
                                                                     "\\search-alt-2-regular-24.png"))
        ...
        def save_record():
            ...
            if nametxt.get()=='' or mobiletxt.get()=='' or emailtxt.get()=='' or licensetxt.get()=='' or passwordtxt.get()=='':
                ...
                if result == True:
                    msg1 = messagebox.showinfo("Cab Booking System", "Driver is registered successfully!")
                else:
                    msg2 = messagebox.showerror("Cab Booking System", "Driver register is unsuccessfull!")
        ...
        def delete():
            ...
            if result==True:
                messagebox.showinfo("Cab Booking System","The user is deleted successfully!")

            else:
                messagebox.showerror("Cab Booking System", "Error occurred!")


        delete_image = customtkinter.CTkImage(light_image=Image.open("C:\\Users\KIIT\OneDrive\Documents\cme project\Cab-Booking-System\Images\\user-x-regular-24.png"))
